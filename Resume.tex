...
\shorterSection{Skills}
  ...
  \vspace{-5pt}
  \item{
    \textbf{Back-end Framework/Libraries}{: Golang gin-gonic, Java Spring-boot, Maven, Azure, IBM DB2}
    \hfill
  }
  \vspace{-5pt}
  \item{
...
\shorterSection{Experiences}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \small
        ...
        \item Practice trunk-based development and continous development
        \item Working on investigating GraphQL and writing single page React application
        \item Practice business agility, Team Pair or Mob programming to attack a challenging problem together
        \item \textbf{Technologies: } React, GraphQL, Subversion
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \small
        ...
        \item \textbf{Technologies: } React, Golang, Azure, TSQL, Git 
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \small
        \item Created a single page management dashboard to keep track of company's intranet performances
        \item Wrote several Angular pipe to optimize segment search engine and used across different internal applications
        ...
        \item \textbf{Technologies:} Atlassian products, Spring-boot MVC, Angular, Ngx Bootstrap, Tortoise Subversion
    \resumeItemListEnd
