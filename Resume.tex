...
\shorterSection{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \small
            \item Working in Scrum Team in solving and handling different stories during each sprint
            \item Helping in develop an internal web application that uses by hundreds of employee
            \item Learning about the business and apply them to the software to create better and easier user experience
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \small
            \item Working with teams designing a full stack internal web application for door configuration
            \item Using different Golang libraries to implement dynamic image generations for each door parts and React to present them in a configuration dashboard
            \item Code review with peers for each pull request to avoid and bugs and conflicts
            \item Learn about doors and the industry to optimize user expereience
      \resumeItemListEnd
    \resumeSubheading
      {Werner Enterprises}{Omaha, NE}
      {Technical Intern - Full Stack}{May 2019 - Aug 2019}
      \resumeItemListStart
        \resumeItem{Intermodal Management Dashboard}
          {Designed a Fullstack internal web application that manages Werner's Intermodal ITS, Logistic data and Business data
            \begin{itemize}
                \item Use Spring boot with Maven for processing data, creating and handling Open Authentication and managing REST endpoint
